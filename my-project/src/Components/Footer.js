    ...
    // </div>
      ...
      <div className="footer bg-black">
        <div className="relative flex  flex-row ">
          <div className="  w-1/3 h-[150px] flex justify-center  border-1 items-center   ">
                <ul>
          ...
          <div className="  w-1/3 h-[150px] flex justify-center  border-1 items-center space-x-4 flex-row   ">
